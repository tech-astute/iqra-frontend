...
const Language = (props) => {
    ...
    const emptyRows = page > 0 ? Math.max(0, (1 + page) * rowsPerPage - languagesTable.length) : 0;

    const filteredUsers = applySortFilter(languagesTable, getComparator(order, orderBy), filterName);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setLanguagesTable([...languagesTable, language]);
            setLanguage({
                language: ''
            });
                    ...
                    <TableContainer sx={{ minWidth: 800 }}>
                        <Table>
                            <UserListHead
                                ...
                                rowCount={languagesTable.length}
